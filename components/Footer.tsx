...
const SOCIAL = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/theaviatortrainingschool/',
    icon: (
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@theaviatortrainingschool',
    icon: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
...
export default function Footer() {
  return (
    <footer className="relative z-10 py-12 px-[5%] border-t" style={{ background: 'rgba(0,0,0,.25)', borderColor: 'rgba(255,255,255,.04)' }}>
      <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-10 mb-10">

        {/* Brand */}
        <div>
          <span
            className="text-[1.1rem] font-semibold tracking-[3px] block mb-3"
            ...
            {SOCIAL.map(s => (
              <a
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLElement).style.borderColor = 'rgba(212,175,55,.35)';
                  (e.currentTarget as HTMLElement).style.background = 'rgba(212,175,55,.07)';
                }}
                onMouseLeave={e => {
        ...
        {/* Programs */}
        <div>
          <h4 className="text-[.55rem] font-bold tracking-[2.5px] uppercase mb-3" style={{ color: 'var(--gold)' }}>
            Programs
          </h4>
          <ul className="list-none flex flex-col gap-2">
            {[
              ...
              <li key={l.href}>
                <Link href={l.href}
                  className="text-[.75rem] no-underline transition-colors"
